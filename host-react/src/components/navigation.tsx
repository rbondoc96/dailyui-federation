...
export function Navigation(): ReactNode {
    ...
    if (isDesktop) {
        return (
            <Dialog.Root open={open} onOpenChange={setOpen}>
                <NavigationToolbar>
                    <Dialog.Trigger className="text-purple-400 underline underline-offset-3">Open Menu</Dialog.Trigger>
                </NavigationToolbar>
                <Dialog.Portal>
                    <Dialog.Overlay
    ...
    return (
        <Drawer.Root shouldScaleBackground open={open} onOpenChange={setOpen}>
            <NavigationToolbar>
                <Drawer.Trigger className="text-purple-400 bg-white">Open Menu</Drawer.Trigger>
            </NavigationToolbar>
            {/* <Drawer.Trigger
                className={cn(
